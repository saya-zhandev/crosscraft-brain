...
export const ResizableHandle = ({
  ...
  <ResizablePrimitive.PanelResizeHandle
    className={cn(
      'relative flex w-px items-center justify-center bg-border transition-colors hover:bg-accent/60 data-[resize-handle-state=drag]:bg-accent',
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-5 w-3 items-center justify-center rounded-sm border border-border bg-panel-2">
        <GripVertical className="size-2.5 text-muted" />
      </div>
    )}
  </ResizablePrimitive.PanelResizeHandle>
);
